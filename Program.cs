...
builder.Services.AddSingleton<DeathwatchMobile.Services.SkillLibraryService>();
builder.Services.AddScoped<DeathwatchMobile.Services.CharacterSkillService>();
builder.Services.AddScoped<DeathwatchMobile.Services.CharacterSheetService>();
